...
LOG_NAME="${LOG_NAME:-${_LAUNCH_TIMESTAMP}${ALB_TAG}${ECBB_TAG}_seq${SEQ_K}k_steps${CFG_TOTAL_STEPS}_pp${CFG_PP_SIZE}_h${CFG_HEAD_SIZE}_c${CFG_CONTEXT_SIZE}_ws${CFG_WINDOW_SIZE}${FLASH_TAG}}"

export CFG_SEQ_LEN CFG_TOTAL_STEPS CFG_PP_SIZE CFG_HEAD_SIZE CFG_CONTEXT_SIZE CFG_WINDOW_SIZE CFG_USE_FLASH_ATTN CFG_NPU_FIXEDLEN_FLASH_2D CFG_OVERLAP_SYNC_GRAD CFG_OVERLAP_SYNC_PARAM CFG_FIXED_RANDOM_DATASET_SEQLEN CFG_EMPTY_CACHE_AND_DIAG_INTERVAL CFG_EMPTY_CACHE_BEFORE_BACKWARD LOG_NAME
