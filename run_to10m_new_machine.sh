...
LOG_NAME="${LOG_NAME:-${_LAUNCH_TIMESTAMP}${ALB_TAG}_seq${SEQ_K}k_steps${CFG_TOTAL_STEPS}_pp${CFG_PP_SIZE}_h${CFG_HEAD_SIZE}_c${CFG_CONTEXT_SIZE}_ws${CFG_WINDOW_SIZE}${FLASH_TAG}}"
